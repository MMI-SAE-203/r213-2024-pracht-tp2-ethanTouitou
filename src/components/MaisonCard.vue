...
<template>
    <div
        ...
        <div class="self-stretch flex-grow-0 flex-shrink-0 h-[200px]">
            <div class="w-[342px] h-[200px] absolute left-[-0.5px] top-[-0.5px] rounded-tl-lg rounded-tr-lg bg-gray-500">
            </div>
            <ImgPb :record="props" :filename="imageMaison"
        ...
        <div
            ...
            <div class="flex justify-between items-start self-stretch flex-grow-0 flex-shrink-0 relative">
                ...
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <circle cx="24" cy="24" r="23.25" fill="with" stroke="#E0E7FF" stroke-width="1.5"></circle>
            ...
            <p class="self-stretch flex-grow-0 flex-shrink-0 w-[302px] text-base text-left text-gray-500">
                2699 Green Valley, Highland Lake
            </p>
            <svg width="302" height="2" viewBox="0 0 302 2" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 gap-1.5">
                ...
                <div class="flex justify-center items-center flex-grow relative gap-2">
                    <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="flex-grow-0 flex-shrink-0 w-5 h-5 relative" preserveAspectRatio="xMidYMid meet">
                        <g clip-path="url(#clip0_32922_502)">
                            <path
                            ...
                            <path d="M3.83325 17.5L4.66659 16.25" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M17.1666 17.5L16.3333 16.25" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                        <defs>
                            <clipPath id="clip0_32922_502">
                ...
                <div class="flex justify-end items-center flex-grow relative gap-2">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g clip-path="url(#clip0_32922_510)">
                            <path
                                d="M8.83148 15.5436L3.45631 10.1685C2.8479 9.56005 2.8479 8.43983 3.45631 7.83142L8.83148 2.45624C9.43989 1.84784 10.5601 1.84784 11.1685 2.45624L16.5437 7.83142C17.1521 8.43983 17.1521 9.56005 16.5437 10.1685L11.1685 15.5436C10.5601 16.152 9.43989 16.152 8.83148 15.5436V15.5436Z"
                                stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round">
                            </path>
                            <path d="M2 13.1716L6.36371 17.5353" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M13.636 17.5353L17.9997 13.1716" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                        <defs>
                            <clipPath id="clip0_32922_510">
                                <rect width="20" height="20" fill="white"></rect>
                            </clipPath>
                        </defs>
                    </svg>
                    <p class="flex-grow-0 flex-shrink-0 text-xs text-left text-gray-600">6x7 m²</p>
                </div>
            </div>
        </div>
    </div>
